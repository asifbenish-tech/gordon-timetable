...
if st in (cp_model.OPTIMAL,cp_model.FEASIBLE):
    ...
    io.open("solution_c.json","w",encoding="utf-8").write(json.dumps(out,ensure_ascii=False,indent=1))
    io.open("circles_c.json","w",encoding="utf-8").write(json.dumps(
    ...
    io.open("deviations_c.txt","w",encoding="utf-8").write("\n".join(lines) or "אין סטיות")
