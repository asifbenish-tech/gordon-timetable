...
if st in (cp_model.OPTIMAL,cp_model.FEASIBLE):
    ...
    print("ספורט חטיבה: ראשון",peh[0],"| רביעי",peh[3])
    ...
    io.open("sol_elem2.json","w",encoding="utf-8").write(json.dumps(out,ensure_ascii=False,indent=1))
    ...
    io.open("dev_elem2.txt","w",encoding="utf-8").write("\n".join(dev))
