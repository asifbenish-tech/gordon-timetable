...
if st in (cp_model.OPTIMAL,cp_model.FEASIBLE):
    ...
    io.open("sed_F.json","w",encoding="utf-8").write(json.dumps(
    ...
    io.open("sol_F.json","w",encoding="utf-8").write(json.dumps(out,ensure_ascii=False,indent=1))
    ...
    io.open("dev_F.txt","w",encoding="utf-8").write("\n".join(dev))
