...
CLASSVIEW = {"לילך", "תדהר", "אורנה מאיר", "גלית זינגר", "חסן", "מיכל", "נועה", "צופיה", "חיקי",
             "עינת"}
# מתוך CLASSVIEW - מי שרואה גם את מערכות המורים (ותו לא: עדיין בלי
# חוסרים, צוות, סדירויות ואילוצים). סימון "tv" ב-access_map.
TEACHVIEW = {"לילך", "מיכל", "חסן", "צופיה", "חיקי", "עינת"}   # רואים גם את המערכת שלהם, מתוך 38
