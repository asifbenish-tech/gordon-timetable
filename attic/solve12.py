...
MAXQ={"אנה":25,"אסיף":20,"דליה":24,"לייה":23,"פנינה":23,"שרית":28,"תניה":18,
      ...
      "טלי":10,"שחר":12}
HATIVA={"לייה":2,"שרית":6,"חסן":10,"מרים":10,"אסיף":18,"תמיר":23}   # שעות מחוץ ליסודי
...
if st in (cp_model.OPTIMAL,cp_model.FEASIBLE):
    ...
    io.open("solution_i.json","w",encoding="utf-8").write(json.dumps(out,ensure_ascii=False,indent=1))
    io.open("circles_i.json","w",encoding="utf-8").write(json.dumps(
    ...
    io.open("deviations_i.txt","w",encoding="utf-8").write("\n".join(lines) or "אין סטיות")
