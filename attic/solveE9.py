...
if st in (cp_model.OPTIMAL,cp_model.FEASIBLE):
    ...
    io.open("sed_fin2.json","w",encoding="utf-8").write(json.dumps(
    ...
    io.open("sol_elem_fin2.json","w",encoding="utf-8").write(json.dumps(out,ensure_ascii=False,indent=1))
    ...
    io.open("dev_elem_fin2.txt","w",encoding="utf-8").write("\n".join(dev))
