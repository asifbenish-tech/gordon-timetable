...
for _tag in ("m","u"): m.Add(blk_h[(_tag,1)]==1)   # both circles at hours 1-2
...
if st in (cp_model.OPTIMAL,cp_model.FEASIBLE):
    ...
    io.open("solution_j.json","w",encoding="utf-8").write(json.dumps(out,ensure_ascii=False,indent=1))
    io.open("circles_j.json","w",encoding="utf-8").write(json.dumps(
    ...
    io.open("deviations_j.txt","w",encoding="utf-8").write("\n".join(lines) or "אין סטיות")
