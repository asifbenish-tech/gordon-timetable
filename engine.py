...
# ד אינס: שתי שעות החצי-כיתה של כל מורת תל"ן ברצף - חגית ביום שני
for _ku in [k for k in hf if k[0]=="ד אינס" and k[2]=="חגית" and k[1][0]!=1]:
    m.Add(hf[_ku]==0)
for _u,_days in (("יעל",range(5)),("חגית",[1])):
    _iad=[]
    for _di in _days:
