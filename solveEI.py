...
POOL={"טלי":(3,B_CL),"ליאור":(6,CLASSES),"מרים":(15,CLASSES),"צופיה":(8,[c for c in CLASSES if c[0] in "אבג"]),"שחר":(2,[c for c in CLASSES if c[0] in "אבג"])}
...
sol=cp_model.CpSolver(); sol.parameters.max_time_in_seconds=300; sol.parameters.num_workers=8; sol.parameters.random_seed=4
