...
m.Add(sum(v)<=18-4)                      # 4 שעות שישי כבר קבועות
...
if st in (cp_model.OPTIMAL,cp_model.FEASIBLE):
    ...
    io.open("sed_G.json","w",encoding="utf-8").write(json.dumps(
    ...
    io.open("sol_G.json","w",encoding="utf-8").write(json.dumps(out,ensure_ascii=False,indent=1))
    ...
    io.open("dev_G.txt","w",encoding="utf-8").write("\n".join(dev))
